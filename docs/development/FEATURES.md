...
You can add MCP servers to Claude Code non-interactively from your terminal by using the `claude mcp add … -- <command> <args…>` pattern (good for `npx`...
- [ ] Pending
-----
...
SearXNG repo already cloned — sk...
- [ ] Pending
-----
...
also, I don't know which one has the number of questions ge...
- [ ] Pending
-----
...
<output-file>/private/tmp/claude-501/-Users-jeremyparker-Desktop-Claude-Coding-Projects-Perpl...
- [ ] Pending
-----
...
**Session:** `23abc4f7...`
**Request:** please look at this codebase and please have the discover feature be a separate spin off app. I want to streamline this app. Instead of it being one mess, I want to have the feeds and discover feature...
- [ ] Pending
-----
...
1
FOMC Summary of Economic Projecti...
- [ ] Pending
-----
...
MY original plan was for the questions to be come up with by the agent, then searches performed for each question, the number of each determined by the user in the configurat...
- [ ] Pending
-----
...
**Session:** `b158d9c0...`
**Request:** please have it so instead of it being "one shot" the ai agent lists the questions it came up with, the number of which would have been preset by the user. then the user selects which ones they wish to...
- [ ] Pending
-----
...
**Session:** `6587054b...`
**Request:** please make sure that the citation checker feature is working as desired. please optimize the deepseek research agents so they are as truthful to the sources as possible. if possible, we should give t...
- [ ] Pending
-----
...
could we also have a system that ranks source credibility so we don't use unrelia...
- [ ] Pending
-----
...
**Session:** `6587054b...`
**Request:** how can we make it so the deepseek agent is almost forced to provide snippets and have those snippets be directly linked to its source. I'd like for the user to be able to click on text in the report ...
- [ ] Pending
-----
...
**Session:** `a02fe5f7...`
**Request:** okay. how would we best deploy it on the m1 mac mini but also have it so I can see the logs on this m3 macbook air on my network? that way we can push file changes over to the m1 mac mini from this co...
- [ ] Pending
-----
